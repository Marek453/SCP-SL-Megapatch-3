...
public class TutorialManager : MonoBehaviour
{
	...
	private void Tutorial2_GiveNTFRifle()
	{
		...
		GameObject.Find("Host").GetComponent<Inventory>().SetPickup(20, 0f, GameObject.Find("ItemPos").transform.position, Quaternion.Euler(-90f, 0f, 0f));
	...
	private void Tutorial2_GiveAmmo()
	{
		...
		GameObject.Find("Host").GetComponent<Inventory>().SetPickup(29, 12f, GameObject.Find("ItemPos").transform.position, default(Quaternion));
	}
	...
	{
		GameObject.Find("Host").GetComponent<Inventory>().SetPickup(22, 9999f, GameObject.Find("ItemPos").transform.position, default(Quaternion));
	}
	...
	{
		GameObject.Find("Host").GetComponent<Inventory>().SetPickup(0, 0f, GameObject.Find("ItemPos").transform.position, default(Quaternion));
	}
