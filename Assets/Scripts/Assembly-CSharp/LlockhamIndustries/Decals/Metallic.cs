...
namespace LlockhamIndustries.Decals
{
	...
	public class Metallic : Projection
	{
		...
		public override Material MobileForward
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Mobile/Metallic/Forward"));
			}
		}
		...
		public override Material MobileDeferredOpaque
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Mobile/Metallic/DeferredOpaque"));
			}
		}
		...
		public override Material MobileDeferredTransparent
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Mobile/Metallic/DeferredTransparent"));
			}
		}
		...
		public override Material StandardForward
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Standard/Metallic/Forward"));
			}
		}
		...
		public override Material StandardDeferredOpaque
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Standard/Metallic/DeferredOpaque"));
			}
		}
		...
		public override Material StandardDeferredTransparent
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Standard/Metallic/DeferredTransparent"));
			}
		}
		...
		public override Material PackedForward
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Packed/Metallic/Forward"));
			}
		}
		...
		public override Material PackedDeferredOpaque
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Packed/Metallic/DeferredOpaque"));
			}
		}
		...
		public override Material PackedDeferredTransparent
		{
			get
			{
				return MaterialFromShader(Shader.Find("Projection/Decal/Packed/Metallic/DeferredTransparent"));
			}
		}
