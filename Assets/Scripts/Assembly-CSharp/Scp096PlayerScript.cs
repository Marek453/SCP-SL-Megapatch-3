...
public class Scp096PlayerScript : NetworkBehaviour
{
	...
	[CompilerGenerated]
	private sealed class _003C_ExecuteServersideCode_Looking_003Ec__Iterator0 : IEnumerator, IDisposable, IEnumerator<float>
	{
		...
		[DebuggerHidden]
		public _003C_ExecuteServersideCode_Looking_003Ec__Iterator0()
		{
		}
	...
	[CompilerGenerated]
	private sealed class _003C_ExecuteServersideCode_RageHandler_003Ec__Iterator1 : IEnumerator, IDisposable, IEnumerator<float>
	{
		internal Scp096PlayerScript _0024this;
		...
		[DebuggerHidden]
		public _003C_ExecuteServersideCode_RageHandler_003Ec__Iterator1()
		{
		}
	...
	public RageState Networkenraged
	{
		...
		set
		{
			ref RageState fieldValue = ref enraged;
	...
	private IEnumerator<float> _ExecuteServersideCode_Looking()
	{
		...
		_003C_ExecuteServersideCode_Looking_003Ec__Iterator0 _003C_ExecuteServersideCode_Looking_003Ec__Iterator = new _003C_ExecuteServersideCode_Looking_003Ec__Iterator0();
		_003C_ExecuteServersideCode_Looking_003Ec__Iterator._0024this = this;
		return _003C_ExecuteServersideCode_Looking_003Ec__Iterator;
	}
	...
	private IEnumerator<float> _ExecuteServersideCode_RageHandler()
	{
		...
		_003C_ExecuteServersideCode_RageHandler_003Ec__Iterator1 _003C_ExecuteServersideCode_RageHandler_003Ec__Iterator = new _003C_ExecuteServersideCode_RageHandler_003Ec__Iterator1();
		_003C_ExecuteServersideCode_RageHandler_003Ec__Iterator._0024this = this;
		return _003C_ExecuteServersideCode_RageHandler_003Ec__Iterator;
	}
	...
	{
		if (ccm.curClass == 9 && Vector3.Distance(GetComponent<PlyMovementSync>().position, target.transform.position) < 3f && enraged == RageState.Enraged)
		{
			GetComponent<CharacterClassManager>().CallRpcPlaceBlood(target.transform.position, 0, 3.1f);
			target.GetComponent<PlayerStats>().HurtPlayer(new PlayerStats.HitInfo(99999f, "SCP096", "SCP:096", GetComponent<QueryProcessor>().PlayerId), target);
		}
	}
