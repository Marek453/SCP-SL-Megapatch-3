...
namespace RemoteAdmin
{
	public class TextBasedRemoteAdmin : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			logs.Add("(SYSTEM) Text Based Remote Admin system started at " + DateTime.Now.ToLongTimeString());
			RefreshConsole();
		}
		...
		private void Update()
		{
			if (Input.GetKeyDown(KeyCode.Return) && ui.loggedIn && ui.opened && !string.IsNullOrEmpty(commandField.text))
			{
				SendCommand();
			}
		}
